...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?= site_url('about') ?>" class="nav-item nav-link active">Tentang</a>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="row g-5">
                <?php foreach ($konfigfoto as $aa) { ?>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px;">
                            <img class="position-absolute w-100 h-100" src="<?= base_url('asset/upload/about/'.$aa['foto_about']) ?>" alt="" style="object-fit: cover;">
                            <img class="position-absolute top-0 start-0 bg-white pe-3 pb-3" src="<?= base_url('asset/upload/about/'.$aa['foto_about']) ?>" alt="" style="width: auto; height: 200px;">
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="h-100">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p><?= $konfigabout->misi; ?></p>
                            </div>
                        </div>

                        <div class="row g-4">
                            <div class="col-sm-6">
                                <a class="d-inline-flex align-items-center btn btn-outline-primary border-2 p-2" href="https://wa.me/62<?= $konfig->no_wa; ?>" target="_blank">
                                    <span class="flex-shrink-0 btn-square bg-primary">
                                        <i class="fa fa-phone-alt text-white"></i>
                                    </span>
                                    <span class="px-3">+62 <?= $konfig->no_wa; ?></span>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h6 class="text-primary text-uppercase mb-2">Anggota</h6>
                <h3 class="mb-4">Sandpaper Team</h3>
            </div>
            <div class="row g-0 team-items justify-content-center">
            <?php foreach ($profil as $aa) { ?>

                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="<?= base_url('asset/upload/profil/' . $aa['foto_profil']) ?>" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href="<?= $aa['facebook'] ?>"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-outline-primary border-2 m-1" href="<?= $aa['tiktok'] ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 26 26" style="fill: #F3BD00;">
                                            <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"></path>
                                        </svg>
                                    </a>
                                    <a class="btn btn-square btn-outline-primary border-2 m-1" href="<?= $aa['instagram'] ?>"><i class="fab fa-instagram"></i></a>
                                </div>
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="mt-2"><?= $aa['nama'] ?></h5>
                            <span><?= $aa['jabatan'] ?></span>
                        </div>
                    </div>
                </div>
